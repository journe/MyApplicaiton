package com.jour.myapplication.base.utils.status.imp

import android.os.Bundle
import com.jour.myapplication.base.utils.status.ViewStatusHelper
...
open class BaseFrameViewStatusHelperImp(parentViewStatusHelper: ViewStatusHelper? = null) : ViewStatusHelper(parentViewStatusHelper) {
     ...
     */
    private val KEY_RECREATE = "com.jour.myapplication.base.utils.status.BaseFrameViewStatusHelperImp.Recreate"
