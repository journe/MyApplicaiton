package com.jour.myapplication.view
...
class RoundCircleImageView : AppCompatImageView {
    ...
    constructor(context: Context, attrs: AttributeSet?, defStyle: Int) : super(
        ...
        val array: TypedArray =
            context.obtainStyledAttributes(attrs, R.styleable.RoundCircleImageView)
        mRoundRadius =
            array.getDimensionPixelOffset(R.styleable.RoundCircleImageView_round_radius, 0)
                .toFloat()
        mTopLeft =
            array.getDimensionPixelOffset(R.styleable.RoundCircleImageView_topLeft, 0).toFloat()
        mTopRight =
            array.getDimensionPixelOffset(R.styleable.RoundCircleImageView_topRight, 0).toFloat()
        mBottomLeft =
            array.getDimensionPixelOffset(R.styleable.RoundCircleImageView_bottomLeft, 0).toFloat()
        mBottomRight =
            array.getDimensionPixelOffset(R.styleable.RoundCircleImageView_bottomRight, 0).toFloat()
        if (array.hasValue(R.styleable.RoundCircleImageView_round_background_color)) {
            val roundBackgroundColor = array.getColor(
                R.styleable.RoundCircleImageView_round_background_color,
                Color.TRANSPARENT
            )
        ...
        if (array.hasValue(R.styleable.RoundCircleImageView_round_background_drawable)) {
            mRoundBackgroundDrawable =
                array.getDrawable(R.styleable.RoundCircleImageView_round_background_drawable)
            mBackgroundBitmap = getBitmapFromDrawable(mRoundBackgroundDrawable)
        }
    ...
    override fun setBackground(background: Drawable) {
        roundBackgroundDrawable = background
    }
    ...
    override fun setBackgroundResource(resId: Int) {
        ...
        roundBackgroundDrawable = drawable
    }
    ...
    var roundBackgroundDrawable: Drawable?
        get() = mRoundBackgroundDrawable
        set(drawable) {
    ...
    private fun setup() {
        ...
        val bitmap = if (mBitmap != null) mBitmap!! else mBackgroundBitmap!!
