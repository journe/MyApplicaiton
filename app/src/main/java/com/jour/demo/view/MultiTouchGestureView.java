...
import com.jour.demo.utils.MultiTouchGestureDetector;
...
public class MultiTouchGestureView extends View {
  ...
  public MultiTouchGestureView(Context context, @Nullable AttributeSet attrs) {
    ...
    mMultiTouchGestureDetector =
        new MultiTouchGestureDetector(context, new MultiTouchGestureDetectorListener());
  ...
  protected void onDraw(Canvas canvas) {
    ...
    canvas.scale(mScaleFactor, mScaleFactor, mIcon.getIntrinsicWidth() / 2,
        mIcon.getIntrinsicHeight() / 2);
  ...
  private final class MultiTouchGestureDetectorListener
      extends MultiTouchGestureDetector.SimpleOnMultiTouchGestureListener {
