...
public class EdgeTransparentView extends FrameLayout {
  ...
  private void init(Context context, AttributeSet attrs) {
    ...
    drawSize = typedArray.getDimension(R.styleable.EdgeTransparentView_edge_width,
        SizeUtils.dp2px(20));
    typedArray.recycle();
  }
  ...
  private void initShader() {
    mPaint.setShader(new LinearGradient(0, 0, 0, drawSize, mGradientColors, mGradientPosition,
