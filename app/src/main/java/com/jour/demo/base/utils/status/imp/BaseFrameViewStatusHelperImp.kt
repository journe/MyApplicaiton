package com.jour.demo.base.utils.status.imp

import android.os.Bundle
import com.jour.demo.base.utils.status.ViewStatusHelper
...
open class BaseFrameViewStatusHelperImp(parentViewStatusHelper: ViewStatusHelper? = null) : ViewStatusHelper(parentViewStatusHelper) {
     ...
     */
    private val KEY_RECREATE = "com.jour.demo.base.utils.status.BaseFrameViewStatusHelperImp.Recreate"
