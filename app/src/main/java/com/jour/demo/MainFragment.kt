...
import com.jour.demo.databinding.FragmentMainBinding
import com.jour.demo.databinding.ItemMainRecyclerBinding
...
class MainFragment : BaseFragment<FragmentMainBinding, EmptyViewModel>() {
	...
	override fun FragmentMainBinding.initView() {
		val list = listOf(
			...
			ItemBean(
				R.drawable.img_main_3, "上拉加载的RecyclerView", R.id.recyclerViewRefreshActivity
			),
...
//			ItemBean(R.drawable.ic_search_bar, "SearchBar", R.id.searchBarFragment),
	...
	data class ItemBean(
		@DrawableRes val image: Int, val title: String, @IdRes val dest: Int
	)
