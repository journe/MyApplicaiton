package com.example.jour.myapplication.utils.notification;
...
import com.example.jour.myapplication.ui.NotificationActivity;
...
public abstract class PlayingNotification {
  ...
  protected NotificationActivity service;
  boolean stopped;

  public synchronized void init(NotificationActivity service) {
  ...
  void updateNotifyModeAndPostNotification(Notification notification) {
    int newNotifyMode = NOTIFY_MODE_FOREGROUND;
