...
import com.example.jour.myapplication.BuildConfig;
...
public class MyGridViewAdpter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = View.inflate(context, R.layout.view_pager_grid_view_item, null);
			holder.tv_name = (TextView) convertView.findViewById(R.id.grid_item_tv);
			holder.iv_nul = (ImageView) convertView.findViewById(R.id.grid_item_iv);
		...
		if (BuildConfig.DEBUG) Log.d("MyGridViewAdpter", lists.get(pos).getName());
